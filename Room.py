class Room():
    ...
    def __init__(self, room_name):
        ...
        #a character attribute to indicate a character in the room

        self.character = None

    #get and set methods for the character in a room

    def set_character_in_room(self, character):
        self.character = character

    def get_character_in_room(self):
